...
public class RestUserController {
    ...
    @PostMapping()
    public ResponseEntity<HttpStatus> createUser(@Valid @RequestBody CreateUserDto dto){
    ...
    @PatchMapping("/{id}")
    public ResponseEntity<HttpStatus> updateUser(@PathVariable("id") Long id,@Valid @RequestBody EditUserDto dto){
